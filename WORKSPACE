...
http_archive(
    ...
    url = "https://github.com/protocolbuffers/protobuf/archive/v3.20.1.zip",
)
...
http_archive(
    ...
    url = "https://github.com/bazelbuild/bazel-skylib/archive/b113ed5d05ccddee3093bb157b9b02ab963c1c32.tar.gz",
)
